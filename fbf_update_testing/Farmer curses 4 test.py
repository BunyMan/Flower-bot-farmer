    ...
    while 1:
        ...
        if key == curses.KEY_UP and current_row_idx > 0:
            ...
            if current_row_idx == 0:
                '''stdscr.addstr(0, 0, 'The Farmer is now awake')'''
                stdscr.refresh()
                stdscr.getch()
                global lcm
                plant_finder()
                ...
                while True:
                    ...
                    if start == 'Y':
                        ...
                        loop_counter_message = input(
                            "Would you like the farmer to send messages to your channel telling you how"
                                                    ...
                                                    def animate():
                                                        ...
                                                        for c in itertools.cycle(['|', '/', '-', '\\']):
                                                            ...
                                                            sys.stdout.write(
                                                                ...
                                                                + str(
                                                                    int(tl)) + ' seconds until next watering cycle. ' + c)
                                                            sys.stdout.flush()
                                                            time.sleep(0.5)
                                                            tl -= 0.5
                                                        sys.stdout.write('\nDone')
