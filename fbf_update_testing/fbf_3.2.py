...
def main():
    ...
    while True:
        ...
        if start == 'Y':
            ...
            try:
                with open('loop_counter', 'r') as f:
                    lc = toml.load(f)
                    global loop_counter
                    loop_counter = lc['loop_counter']
                    f.close()
            except:
                with open('loop_counter', 'w') as f:
                            ...
                            try:
                                for plant in f.readlines():
                                    ...
                                    if payload_counter == line_count:
                                        ...
                                        loop_counter += 1
                                        try:
                                            with open('loop_counter', 'w') as lc:
                                                lc.write('loop_counter = ' + loop_counter)
                                                lc.close()
                                        except:
                                            print('Unable to update the loop counter file')
                                        print('\n')
