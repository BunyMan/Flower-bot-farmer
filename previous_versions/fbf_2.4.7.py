...
def README():
    with open('README', 'w') as f:
        f.write('Ola Rodrigo.')
        f.write('\n')
        f.write('Se estas a ler isto e porque es gay. Esta merda ainda nao esta bem como eu queria mas esta a chegar ')
        f.write('\n')
        f.write('la e esta mais que bom para o que e... Enfim, ha um erro que eu nao tenho paciencia para corrigir')
        f.write('\n')
        f.write('antes de te mandar esta merda pura e simplesmente porque passei o dia a fazer isto mais user-friendly')
        f.write('\n')
        f.write('e esta me a doer a cabeca. Nao e nada de mais mas no fim da lista das plantas ele cria uma linha em')
        f.write('\n')
        f.write('branco a mais e depois tenta regar essa linha em branco e e uma chatisse... Podes apagar a linha em')
        f.write('\n')
        f.write('branco do ficheiro que ele vai criar e ele deixa de fazer isso.')
        f.write('\n')
        f.write('Continuas a ser gay')
        f.write('\n')
        f.write('Cagalhoto no copo')
        f.write('\n')
        f.write('Amen')
        f.close()
            ...
            def add_plants():
                ...
                if plant_name == 0:
                    print('Your plants list has been updated. The farmer will now kill itself, please restart the '
                          'farmer for your changes to take effect. E ja agora le o README')
                    pf.close()
                    time.sleep(4)
                    exit()
